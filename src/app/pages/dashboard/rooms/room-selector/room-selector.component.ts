...
ClicSYS() {
  ...
  CrearElemento(){
    const contadorPaquetes = interval(5000)
    contadorPaquetes.subscribe((n) =>{
      this.VisibilidadPaquetesST6();
      this.VisibilidadPaquetesST3();
      this.VisibilidadPaquetesST7();
      this.VisibilidadPaquetesST8();
      this.VisibilidadPaquetesST9();
      this.VisibilidadPaquetesST10();
      this.VisibilidadPaquetesST11();
      this.VisibilidadPaquetesST12();
      this.VisibilidadPaquetesST13();
      this.VisibilidadPaquetesST14();
      this.VisibilidadPaquetesST15();
      this.VisibilidadPaquetesST4();
      this.VisibilidadPaquetesST5();
      this.VisibilidadPaquetesST1();
      this.VisibilidadPaquetesST2();
    });
  ...
  //  this.DibujarElementoSVGFor();
  // this.DibujarElementoSVG();
  // this.VisibleElemento();
  // this.VisibilidadPaquetesApi();

}

VisibilidadPaquetesST1(){

  for(let i = this.contPaqueteST1; i > 0; i--){
    var elemento = document.getElementById("paqueteST1" + i);
  ...
  this.contPaqueteST1 = 0;
  
  this.apiGetComp.GetJson(this.api.apiUrlMatbox + '/MachineColor/GetPackagesWIP?idDevice=20').subscribe((res: any) => {
      // console.log(res[2].valor);
      // console.log(res.length);
      for(let i = 0; i<res.length; i++){
        this.contPaqueteST1 = this.contPaqueteST1 + 1;
        // console.log(res[i])
        var elemento = document.getElementById("paqueteST1" + this.contPaqueteST1);
        let objeto = {
          visibility:"visible",
          stroke: res[i].valor,
          fill: res[i].valor   
...
VisibilidadPaquetesST2(){

  for(let i = this.contPaqueteST2; i > 0; i--){
    var elemento = document.getElementById("paqueteST2" + i);
  ...
  this.contPaqueteST2 = 0;
  
  this.apiGetComp.GetJson(this.api.apiUrlMatbox + '/MachineColor/GetPackagesWIP?idDevice=21').subscribe((res: any) => {
      // console.log(res[2].valor);
      // console.log(res.length);
      for(let i = 0; i<res.length; i++){
        this.contPaqueteST2 = this.contPaqueteST2 + 1;
        // console.log(res[i])
        var elemento = document.getElementById("paqueteST2" + this.contPaqueteST2);
        let objeto = {
          visibility:"visible",
          stroke: res[i].valor,
          fill: res[i].valor   
...
VisibilidadPaquetesST5(){

  for(let i = this.contPaqueteST5; i > 0; i--){
    var elemento = document.getElementById("paqueteST5" + i);
  ...
  this.contPaqueteST5 = 0;
  
  this.apiGetComp.GetJson(this.api.apiUrlMatbox + '/MachineColor/GetPackagesWIP?idDevice=25').subscribe((res: any) => {
      // console.log(res[2].valor);
      // console.log(res.length);
      for(let i = 0; i<res.length; i++){
        this.contPaqueteST5 = this.contPaqueteST5 + 1;
        // console.log(res[i])
        var elemento = document.getElementById("paqueteST5" + this.contPaqueteST5);
        let objeto = {
          visibility:"visible",
          stroke: res[i].valor,
          fill: res[i].valor   
...
VisibilidadPaquetesST6(){

  for(let i = this.contPaqueteST6; i > 0; i--){
    var elemento = document.getElementById("paqueteST6" + i);
  ...
  this.contPaqueteST6 = 0;
  
  this.apiGetComp.GetJson(this.api.apiUrlMatbox + '/MachineColor/GetPackagesWIP?idDevice=26').subscribe((res: any) => {
      // console.log(res[2].valor);
      // console.log(res.length);
      for(let i = 0; i<res.length; i++){
        this.contPaqueteST6 = this.contPaqueteST6 + 1;
        // console.log(res[i])
        var elemento = document.getElementById("paqueteST6" + this.contPaqueteST6);
        let objeto = {
          visibility:"visible",
          stroke: res[i].valor,
          fill: res[i].valor   
...
VisibilidadPaquetesST3(){

  for(let i = this.contPaqueteST3; i > 0; i--){
    var elemento = document.getElementById("paqueteST3" + i);
  ...
  this.contPaqueteST3 = 0;
  
  this.apiGetComp.GetJson(this.api.apiUrlMatbox + '/MachineColor/GetPackagesWIP?idDevice=23').subscribe((res: any) => {
      // console.log(res[2].valor);
      // console.log(res.length);
      for(let i = 0; i<res.length; i++){
        this.contPaqueteST3 = this.contPaqueteST3 + 1;
        // console.log(res[i])
        var elemento = document.getElementById("paqueteST3" + this.contPaqueteST3);
        let objeto = {
          visibility:"visible",
          stroke: res[i].valor,
          fill: res[i].valor   
...
VisibilidadPaquetesST4(){

  for(let i = this.contPaqueteST4; i > 0; i--){
    var elemento = document.getElementById("paqueteST4" + i);
  ...
  this.contPaqueteST4 = 0;
  
  this.apiGetComp.GetJson(this.api.apiUrlMatbox + '/MachineColor/GetPackagesWIP?idDevice=24').subscribe((res: any) => {
      // console.log(res[2].valor);
      // console.log(res.length);
      for(let i = 0; i<res.length; i++){
        this.contPaqueteST4 = this.contPaqueteST4 + 1;
        // console.log(res[i])
        var elemento = document.getElementById("paqueteST4" + this.contPaqueteST4);
        let objeto = {
          visibility:"visible",
          stroke: res[i].valor,
          fill: res[i].valor   
...
VisibilidadPaquetesST7(){

  for(let i = this.contPaqueteST7; i > 0; i--){
    var elemento = document.getElementById("paqueteST7" + i);
  ...
  this.contPaqueteST7 = 0;
  
  this.apiGetComp.GetJson(this.api.apiUrlMatbox + '/MachineColor/GetPackagesWIP?idDevice=30').subscribe((res: any) => {
      // console.log(res[2].valor);
      // console.log(res.length);
      for(let i = 0; i<res.length; i++){
        this.contPaqueteST7 = this.contPaqueteST7 + 1;
        // console.log(res[i])
        var elemento = document.getElementById("paqueteST7" + this.contPaqueteST7);
        let objeto = {
          visibility:"visible",
          stroke: res[i].valor,
          fill: res[i].valor   
...
VisibilidadPaquetesST8(){

  for(let i = this.contPaqueteST8; i > 0; i--){
    var elemento = document.getElementById("paqueteST8" + i);
  ...
  this.contPaqueteST8 = 0;
  
  this.apiGetComp.GetJson(this.api.apiUrlMatbox + '/MachineColor/GetPackagesWIP?idDevice=31').subscribe((res: any) => {
      // console.log(res[2].valor);
      // console.log(res.length);
      for(let i = 0; i<res.length; i++){
        this.contPaqueteST8 = this.contPaqueteST8 + 1;
        // console.log(res[i])
        var elemento = document.getElementById("paqueteST8" + this.contPaqueteST8);
        let objeto = {
          visibility:"visible",
          stroke: res[i].valor,
          fill: res[i].valor   
...
VisibilidadPaquetesST9(){

  for(let i = this.contPaqueteST9; i > 0; i--){
    var elemento = document.getElementById("paqueteST9" + i);
  ...
  this.contPaqueteST9 = 0;
  
  this.apiGetComp.GetJson(this.api.apiUrlMatbox + '/MachineColor/GetPackagesWIP?idDevice=32').subscribe((res: any) => {
      // console.log(res[2].valor);
      // console.log(res.length);
      for(let i = 0; i<res.length; i++){
        this.contPaqueteST9 = this.contPaqueteST9 + 1;
        // console.log(res[i])
        var elemento = document.getElementById("paqueteST9" + this.contPaqueteST9);
        let objeto = {
          visibility:"visible",
          stroke: res[i].valor,
          fill: res[i].valor   
...
VisibilidadPaquetesST10(){

  for(let i = this.contPaqueteST10; i > 0; i--){
    var elemento = document.getElementById("paqueteST10" + i);
  ...
  this.contPaqueteST10 = 0;
  
  this.apiGetComp.GetJson(this.api.apiUrlMatbox + '/MachineColor/GetPackagesWIP?idDevice=33').subscribe((res: any) => {
      // console.log(res[2].valor);
      // console.log(res.length);
      for(let i = 0; i<res.length; i++){
        this.contPaqueteST10 = this.contPaqueteST10 + 1;
        // console.log(res[i])
        var elemento = document.getElementById("paqueteST10" + this.contPaqueteST10);
        let objeto = {
          visibility:"visible",
          stroke: res[i].valor,
          fill: res[i].valor   
...
VisibilidadPaquetesST11(){

  for(let i = this.contPaqueteST11; i > 0; i--){
    var elemento = document.getElementById("paqueteST11" + i);
  ...
  this.contPaqueteST11 = 0;
  
  this.apiGetComp.GetJson(this.api.apiUrlMatbox + '/MachineColor/GetPackagesWIP?idDevice=34').subscribe((res: any) => {
      // console.log(res[2].valor);
      // console.log(res.length);
      for(let i = 0; i<res.length; i++){
        this.contPaqueteST11 = this.contPaqueteST11 + 1;
        // console.log(res[i])
        var elemento = document.getElementById("paqueteST11" + this.contPaqueteST11);
        let objeto = {
          visibility:"visible",
          stroke: res[i].valor,
          fill: res[i].valor   
...
VisibilidadPaquetesST12(){

  for(let i = this.contPaqueteST12; i > 0; i--){
    var elemento = document.getElementById("paqueteST12" + i);
  ...
  this.contPaqueteST12 = 0;
  
  this.apiGetComp.GetJson(this.api.apiUrlMatbox + '/MachineColor/GetPackagesWIP?idDevice=35').subscribe((res: any) => {
      // console.log(res[2].valor);
      // console.log(res.length);
      for(let i = 0; i<res.length; i++){
        this.contPaqueteST12 = this.contPaqueteST12 + 1;
        // console.log(res[i])
        var elemento = document.getElementById("paqueteST12" + this.contPaqueteST12);
        let objeto = {
          visibility:"visible",
          stroke: res[i].valor,
          fill: res[i].valor   
...
VisibilidadPaquetesST13(){

  for(let i = this.contPaqueteST13; i > 0; i--){
    var elemento = document.getElementById("paqueteST13" + i);
  ...
  this.contPaqueteST13 = 0;
  
  this.apiGetComp.GetJson(this.api.apiUrlMatbox + '/MachineColor/GetPackagesWIP?idDevice=36').subscribe((res: any) => {
      // console.log(res[2].valor);
      // console.log(res.length);
      for(let i = 0; i<res.length; i++){
        this.contPaqueteST13 = this.contPaqueteST13 + 1;
        // console.log(res[i])
        var elemento = document.getElementById("paqueteST13" + this.contPaqueteST13);
        let objeto = {
          visibility:"visible",
          stroke: res[i].valor,
          fill: res[i].valor   
...
VisibilidadPaquetesST14(){

  for(let i = this.contPaqueteST14; i > 0; i--){
    var elemento = document.getElementById("paqueteST14" + i);
  ...
  this.contPaqueteST14 = 0;
  
  this.apiGetComp.GetJson(this.api.apiUrlMatbox + '/MachineColor/GetPackagesWIP?idDevice=37').subscribe((res: any) => {
      // console.log(res[2].valor);
      // console.log(res.length);
      for(let i = 0; i<res.length; i++){
        this.contPaqueteST14 = this.contPaqueteST14 + 1;
        // console.log(res[i])
        var elemento = document.getElementById("paqueteST14" + this.contPaqueteST14);
        let objeto = {
          visibility:"visible",
          stroke: res[i].valor,
          fill: res[i].valor   
...
VisibilidadPaquetesST15(){

  for(let i = this.contPaqueteST15; i > 0; i--){
    var elemento = document.getElementById("paqueteST15" + i);
  ...
  this.contPaqueteST15 = 0;
  
  this.apiGetComp.GetJson(this.api.apiUrlMatbox + '/MachineColor/GetPackagesWIP?idDevice=38').subscribe((res: any) => {
      // console.log(res[2].valor);
      // console.log(res.length);
      for(let i = 0; i<res.length; i++){
        this.contPaqueteST15 = this.contPaqueteST15 + 1;
        // console.log(res[i])
        var elemento = document.getElementById("paqueteST15" + this.contPaqueteST15);
        let objeto = {
          visibility:"visible",
          stroke: res[i].valor,
          fill: res[i].valor   

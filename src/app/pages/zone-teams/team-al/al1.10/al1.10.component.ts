...
@Component({
  selector: 'ngx-al1_10',
  templateUrl: './al1.10.component.html',
  styleUrls: ['./al1.10.component.scss']
})
export class Al1_10Component implements OnInit {

  private alive=true;

  public TeamAL1_10: DeviceXpl;

  
  public velocidadAL1_10: any = 0;
  intervalSubscriptionItems?: Subscription;

  @ViewChild('gaugeAL1_10')
...
public tooltipInterval1: number;
  ...
  gauge(){
    if (document.getElementById('sample-data')) {
      let value1: number = this.velocidadAL1_10;
  ...
  ngAfterViewInit(): void {
    ...
    this.tooltipInterval1 = window.setInterval(
        ...
        (): void => {
            if (document.getElementById('sample-dataAL1_10')) {
                let value1: number = this.velocidadAL1_10;
...
changeAL1_1() {
    this.apiGetComp.GetJson(this.api.urlapixplmatbagapp02 + '/api/v1/device?device=' + 'AL1_10')
    ...
    .subscribe((res: any)=>{
      ...
      this.TeamAL1_10 = res[0]
      this.velocidadAL1_10 = this.TeamAL1_10?.VelocidadActualMotor ?? 0;
  ...
  dataAL1_1(){
    ...
    .pipe(
      ...
      switchMap( () => this.apiGetComp.GetJson(this.api.urlapixplmatbagapp02 + '/api/v1/device?device=' + 'AL1_10'))
    )
    .subscribe((res: any) => {

...
@Component({
  selector: 'ngx-al1_11',
  templateUrl: './al1.11.component.html',
  styleUrls: ['./al1.11.component.scss']
})
export class Al1_11Component implements OnInit {

  private alive=true;

  public TeamAL1_11: DeviceXpl;

  
  public velocidadAL1_11: any = 0;
  intervalSubscriptionItems?: Subscription;

  @ViewChild('gaugeAL1_11')
...
public tooltipInterval1: number;
  ...
  gauge(){
    if (document.getElementById('sample-data')) {
      let value1: number = this.velocidadAL1_11;
  ...
  ngAfterViewInit(): void {
    ...
    this.tooltipInterval1 = window.setInterval(
        ...
        (): void => {
            if (document.getElementById('sample-dataAL1_11')) {
                let value1: number = this.velocidadAL1_11;
...
changeAL1_1() {
    this.apiGetComp.GetJson(this.api.urlapixplmatbagapp02 + '/api/v1/device?device=' + 'AL1_11')
    ...
    .subscribe((res: any)=>{
      ...
      this.TeamAL1_11 = res[0]
      this.velocidadAL1_11 = this.TeamAL1_11?.VelocidadActualMotor ?? 0;
  ...
  dataAL1_1(){
    ...
    .pipe(
      ...
      switchMap( () => this.apiGetComp.GetJson(this.api.urlapixplmatbagapp02 + '/api/v1/device?device=' + 'AL1_11'))
    )
    .subscribe((res: any) => {

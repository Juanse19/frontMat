...
@Component({
  selector: 'ngx-al1_2',
  templateUrl: './al1.2.component.html',
  styleUrls: ['./al1.2.component.scss']
})
export class Al1_2Component implements OnInit {

  private alive=true;

  public TeamAL1_2: DeviceXpl;

  
  public velocidadAL1_2: any = 0;
  intervalSubscriptionItems?: Subscription;

  @ViewChild('gaugeAL1_2')
...
public tooltipInterval1: number;
  ...
  gauge(){
    if (document.getElementById('sample-data')) {
      let value1: number = this.velocidadAL1_2;
...
changeAL1_1() {
    this.apiGetComp.GetJson(this.api.urlapixplmatbagapp02 + '/api/v1/device?device=' + 'AL1_2')
    ...
    .subscribe((res: any)=>{
      ...
      this.TeamAL1_2 = res[0]
      this.velocidadAL1_2 = this.TeamAL1_2?.VelocidadActualMotor ?? 0;
  ...
  dataAL1_1(){
    ...
    .pipe(
      ...
      switchMap( () => this.apiGetComp.GetJson(this.api.urlapixplmatbagapp02 + '/api/v1/device?device=' + 'AL1_2'))
    )
    .subscribe((res: any) => {

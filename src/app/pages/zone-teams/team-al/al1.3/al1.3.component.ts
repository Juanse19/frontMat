...
@Component({
  selector: 'ngx-al1_3',
  templateUrl: './al1.3.component.html',
  styleUrls: ['./al1.3.component.scss']
})
export class Al1_3Component implements OnInit {

  private alive=true;

  public TeamAL1_3: DeviceXpl;

  
  public velocidadAL1_3: any = 0;
  intervalSubscriptionItems?: Subscription;

  @ViewChild('gaugeAL1_3')
...
public tooltipInterval1: number;
  ...
  gauge(){
    if (document.getElementById('sample-data')) {
      let value1: number = this.velocidadAL1_3;
  ...
  ngAfterViewInit(): void {
    ...
    this.tooltipInterval1 = window.setInterval(
        ...
        (): void => {
            if (document.getElementById('sample-dataAL1_3')) {
                let value1: number = this.velocidadAL1_3;
...
changeAL1_1() {
    this.apiGetComp.GetJson(this.api.urlapixplmatbagapp02 + '/api/v1/device?device=' + 'AL1_3')
    ...
    .subscribe((res: any)=>{
      ...
      this.TeamAL1_3 = res[0]
      this.velocidadAL1_3 = this.TeamAL1_3?.VelocidadActualMotor ?? 0;
  ...
  dataAL1_1(){
    ...
    .pipe(
      ...
      switchMap( () => this.apiGetComp.GetJson(this.api.urlapixplmatbagapp02 + '/api/v1/device?device=' + 'AL1_3'))
    )
    .subscribe((res: any) => {

...
@Component({
  selector: 'ngx-al1_4',
  templateUrl: './al1.4.component.html',
  styleUrls: ['./al1.4.component.scss']
})
export class Al1_4Component implements OnInit {

  private alive=true;

  public TeamAL1_4: DeviceXpl;

  
  public velocidadAL1_4: any = 0;
  intervalSubscriptionItems?: Subscription;

  @ViewChild('gaugeAL1_4')
...
public tooltipInterval1: number;
  ...
  gauge(){
    if (document.getElementById('sample-data')) {
      let value1: number = this.velocidadAL1_4;
  ...
  ngAfterViewInit(): void {
    ...
    this.tooltipInterval1 = window.setInterval(
        ...
        (): void => {
            if (document.getElementById('sample-dataAL1_4')) {
                let value1: number = this.velocidadAL1_4;
...
changeAL1_1() {
    this.apiGetComp.GetJson(this.api.urlapixplmatbagapp02 + '/api/v1/device?device=' + 'AL1_4')
    ...
    .subscribe((res: any)=>{
      ...
      this.TeamAL1_4 = res[0]
      this.velocidadAL1_4 = this.TeamAL1_4?.VelocidadActualMotor ?? 0;
  ...
  dataAL1_1(){
    ...
    .pipe(
      ...
      switchMap( () => this.apiGetComp.GetJson(this.api.urlapixplmatbagapp02 + '/api/v1/device?device=' + 'AL1_4'))
    )
    .subscribe((res: any) => {

...
@Component({
  selector: 'ngx-al1_5',
  templateUrl: './al1.5.component.html',
  styleUrls: ['./al1.5.component.scss']
})
export class Al1_5Component implements OnInit {

  private alive=true;

  public TeamAL1_5: DeviceXpl;

  
  public velocidadAL1_5: any = 0;
  intervalSubscriptionItems?: Subscription;

  @ViewChild('gaugeAL1_5')
...
public tooltipInterval1: number;
  ...
  gauge(){
    if (document.getElementById('sample-data')) {
      let value1: number = this.velocidadAL1_5;
  ...
  ngAfterViewInit(): void {
    ...
    this.tooltipInterval1 = window.setInterval(
        ...
        (): void => {
            if (document.getElementById('sample-dataAL1_5')) {
                let value1: number = this.velocidadAL1_5;
...
changeAL1_1() {
    ...
    .subscribe((res: any)=>{
      ...
      this.TeamAL1_5 = res[0]
      this.velocidadAL1_5 = this.TeamAL1_5?.VelocidadActualMotor ?? 0;

...
@Component({
  selector: 'ngx-al1_6',
  templateUrl: './al1.6.component.html',
  styleUrls: ['./al1.6.component.scss']
})
export class Al1_6Component implements OnInit {

  private alive=true;

  public TeamAL1_6: DeviceXpl;

  
  public velocidadAL1_6: any = 0;
  intervalSubscriptionItems?: Subscription;

  @ViewChild('gaugeAL1_6')
...
public tooltipInterval1: number;
  ...
  gauge(){
    if (document.getElementById('sample-data')) {
      let value1: number = this.velocidadAL1_6;
  ...
  ngAfterViewInit(): void {
    ...
    this.tooltipInterval1 = window.setInterval(
        ...
        (): void => {
            if (document.getElementById('sample-dataAL1_6')) {
                let value1: number = this.velocidadAL1_6;
...
changeAL1_1() {
    this.apiGetComp.GetJson(this.api.urlapixplmatbagapp02 + '/api/v1/device?device=' + 'AL1_6')
    ...
    .subscribe((res: any)=>{
      ...
      this.TeamAL1_6 = res[0]
      this.velocidadAL1_6 = this.TeamAL1_6?.VelocidadActualMotor ?? 0;
  ...
  dataAL1_1(){
    ...
    .pipe(
      ...
      switchMap( () => this.apiGetComp.GetJson(this.api.urlapixplmatbagapp02 + '/api/v1/device?device=' + 'AL1_6'))
    )
    .subscribe((res: any) => {

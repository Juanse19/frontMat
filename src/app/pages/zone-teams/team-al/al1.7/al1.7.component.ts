...
@Component({
  selector: 'ngx-al1_7',
  templateUrl: './al1.7.component.html',
  styleUrls: ['./al1.7.component.scss']
})
export class Al1_7Component implements OnInit {

  private alive=true;

  public TeamAL1_7: DeviceXpl;

  
  public velocidadAL1_7: any = 0;
  intervalSubscriptionItems?: Subscription;

  @ViewChild('gaugeAL1_7')
...
public tooltipInterval1: number;
  ...
  gauge(){
    if (document.getElementById('sample-data')) {
      let value1: number = this.velocidadAL1_7;
  ...
  ngAfterViewInit(): void {
    ...
    this.tooltipInterval1 = window.setInterval(
        ...
        (): void => {
            if (document.getElementById('sample-dataAL1_7')) {
                let value1: number = this.velocidadAL1_7;
...
changeAL1_1() {
    this.apiGetComp.GetJson(this.api.urlapixplmatbagapp02 + '/api/v1/device?device=' + 'AL1_7')
    ...
    .subscribe((res: any)=>{
      ...
      this.TeamAL1_7 = res[0]
      this.velocidadAL1_7 = this.TeamAL1_7?.VelocidadActualMotor ?? 0;
  ...
  dataAL1_1(){
    ...
    .pipe(
      ...
      switchMap( () => this.apiGetComp.GetJson(this.api.urlapixplmatbagapp02 + '/api/v1/device?device=' + 'AL1_7'))
    )
    .subscribe((res: any) => {

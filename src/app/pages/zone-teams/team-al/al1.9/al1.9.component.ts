...
@Component({
  selector: 'ngx-al1_9',
  templateUrl: './al1.9.component.html',
  styleUrls: ['./al1.9.component.scss']
})
export class Al1_9Component implements OnInit {

  private alive=true;

  public TeamAL1_9: DeviceXpl;

  
  public velocidadAL1_9: any = 0;
  intervalSubscriptionItems?: Subscription;

  @ViewChild('gaugeAL1_9')
...
public tooltipInterval1: number;
  ...
  gauge(){
    if (document.getElementById('sample-data')) {
      let value1: number = this.velocidadAL1_9;
  ...
  ngAfterViewInit(): void {
    ...
    this.tooltipInterval1 = window.setInterval(
        ...
        (): void => {
            if (document.getElementById('sample-dataAL1_9')) {
                let value1: number = this.velocidadAL1_9;
...
changeAL1_1() {
    this.apiGetComp.GetJson(this.api.urlapixplmatbagapp02 + '/api/v1/device?device=' + 'AL1_9')
    ...
    .subscribe((res: any)=>{
      ...
      this.TeamAL1_9 = res[0]
      this.velocidadAL1_9 = this.TeamAL1_9?.VelocidadActualMotor ?? 0;
  ...
  dataAL1_1(){
    ...
    .pipe(
      ...
      switchMap( () => this.apiGetComp.GetJson(this.api.urlapixplmatbagapp02 + '/api/v1/device?device=' + 'AL1_9'))
    )
    .subscribe((res: any) => {

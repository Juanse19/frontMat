...
@Component({
  selector: 'ngx-al2_3',
  templateUrl: './al2.3.component.html',
  styleUrls: ['./al2.3.component.scss']
})
export class Al2_3Component implements OnInit {

  private alive=true;

  public TeamAL2_3: DeviceXpl;

  
  public velocidadAL2_3: any = 0;
  intervalSubscriptionItems?: Subscription;

  @ViewChild('gaugeAL2_3')
...
public tooltipInterval1: number;
  ...
  gauge(){
    if (document.getElementById('sample-data')) {
      let value1: number = this.velocidadAL2_3;
  ...
  ngAfterViewInit(): void {
    ...
    this.tooltipInterval1 = window.setInterval(
        ...
        (): void => {
            if (document.getElementById('sample-dataAL2_3')) {
                let value1: number = this.velocidadAL2_3;
...
changeAL1_1() {
    this.apiGetComp.GetJson(this.api.urlapixplmatbagapp02 + '/api/v1/device?device=' + 'AL2_3')
    ...
    .subscribe((res: any)=>{
      ...
      this.TeamAL2_3 = res[0]
      this.velocidadAL2_3 = this.TeamAL2_3?.VelocidadActualMotor ?? 0;
  ...
  dataAL1_1(){
    ...
    .pipe(
      ...
      switchMap( () => this.apiGetComp.GetJson(this.api.urlapixplmatbagapp02 + '/api/v1/device?device=' + 'AL2_3'))
    )
    .subscribe((res: any) => {

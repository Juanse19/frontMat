...
changeAL1_1() {
    this.apiGetComp.GetJson(this.api.apiUrlNode1 + '/api/v1/device?device=' + 'AL2_3')
  ...
  dataAL1_1(){
    ...
    .pipe(
      ...
      switchMap( () => this.apiGetComp.GetJson(this.api.apiUrlNode1 + '/api/v1/device?device=' + 'AL2_3'))
    )
    .subscribe((res: any) => {

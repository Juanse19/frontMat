...
export interface CL1_11 {
  CL1_11_VelocidadActualMotor: number,
  CL1_11_CorrienteActualMotor: number,
...
export class Cl1_11Component implements OnInit {

  private alive=true;

  public TeamCL1_11: DeviceXpl;

  public velocidadCL1_11: any = 0;
  intervalSubscriptionItems?: Subscription;

  @ViewChild('gaugeCL1_11')
...
public tooltipInterval1: number;
  ...
  gauge(){
    if (document.getElementById('sample-data')) {
      let value1: number = this.velocidadCL1_11;
  ...
  changeCL1_11() {
    this.apiGetComp.GetJson(this.api.urlapixplmatbagapp02 + '/api/v1/device?device=' + 'CL1_11')
    ...
    .subscribe((res: any)=>{
      ...
      this.velocidadCL1_11 = this.TeamCL1_11?.VelocidadActualMotor ?? 0;
    }
    this.dataCL1_11();
    });
  }
  ...
  dataCL1_11(){
    ...
    .pipe(
      ...
      switchMap( () => this.apiGetComp.GetJson(this.api.urlapixplmatbagapp02 + '/api/v1/device?device=' + 'CL1_11'))
    )
    .subscribe((res: any) => {
      if (JSON.stringify(res)=='{}') {
            console.log('no hay data CL1_11');

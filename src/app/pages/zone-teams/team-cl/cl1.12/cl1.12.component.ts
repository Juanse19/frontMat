...
export interface CL1_12 {
  CL1_12_VelocidadActualMotor: number,
  CL1_12_CorrienteActualMotor: number,
  CL1_12_PotenciaActualMotor: number,
  CL1_12_TorqueActualMotor: number,
  CL1_12_KWh: number,
  CL1_12_voltaje: number
}
...
export class Cl1_12Component implements OnInit {

  private alive=true;

  public TeamCL1_12: DeviceXpl;

  public velocidadCL1_12: any = 0;
  intervalSubscriptionItems?: Subscription;

  @ViewChild('gaugeCL1_12')
...
public tooltipInterval1: number;
  ...
  gauge(){
    if (document.getElementById('sample-data')) {
      let value1: number = this.velocidadCL1_12;
  ...
  changeCL1_12() {
    this.apiGetComp.GetJson(this.api.urlapixplmatbagapp02 + '/api/v1/device?device=' + 'CL1_12')
    ...
    .subscribe((res: any)=>{
      ...
      this.velocidadCL1_12 = this.TeamCL1_12?.VelocidadActualMotor ?? 0;
    }
    this.dataCL1_12();
    });
  }
  ...
  dataCL1_12(){
    ...
    .pipe(
      ...
      switchMap( () => this.apiGetComp.GetJson(this.api.urlapixplmatbagapp02 + '/api/v1/device?device=' + 'CL1_12'))
    )
    .subscribe((res: any) => {
      if (JSON.stringify(res)=='{}') {
            console.log('no hay data CL1_12');

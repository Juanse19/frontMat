...
export interface CL1_7 {
  CL1_7_VelocidadActualMotor: number,
  CL1_7_CorrienteActualMotor: number,
  CL1_7_PotenciaActualMotor: number,
  CL1_7_TorqueActualMotor: number,
  CL1_7_KWh: number,
  CL1_7_voltaje: number
}
...
export class Cl1_7Component implements OnInit {

  private alive=true;

  public TeamCL1_7: DeviceXpl;

  public velocidadCL1_7: any = 0;
  intervalSubscriptionItems?: Subscription;

  @ViewChild('gaugeCL1_7')
...
public tooltipInterval1: number;
  ...
  gauge(){
    if (document.getElementById('sample-data')) {
      let value1: number = this.velocidadCL1_7;
  ...
  changeCL1_7() {
    this.apiGetComp.GetJson(this.api.urlapixplmatbagapp02 + '/api/v1/device?device=' + 'CL1_7')
    ...
    .subscribe((res: any)=>{
      ...
      this.velocidadCL1_7 = this.TeamCL1_7?.VelocidadActualMotor ?? 0;
    }
    this.dataCL1_7();
    });
  }
  ...
  dataCL1_7(){
    ...
    .pipe(
      ...
      switchMap( () => this.apiGetComp.GetJson(this.api.urlapixplmatbagapp02 + '/api/v1/device?device=' + 'CL1_7'))
    )
    .subscribe((res: any) => {
      if (JSON.stringify(res)=='{}') {
            console.log('no hay data CL1_7');

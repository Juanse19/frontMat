...
export interface CL1_9 {
  CL1_9_VelocidadActualMotor: number,
  CL1_9_CorrienteActualMotor: number,
  CL1_9_PotenciaActualMotor: number,
  CL1_9_TorqueActualMotor: number,
  CL1_9_KWh: number,
  CL1_9_voltaje: number
}
...
export class Cl1_9Component implements OnInit {

  private alive=true;

  public TeamCL1_9: DeviceXpl;

  public velocidadCL1_9: any = 0;
  intervalSubscriptionItems?: Subscription;

  @ViewChild('gaugeCL1_9')
...
public tooltipInterval1: number;
  ...
  gauge(){
    if (document.getElementById('sample-data')) {
      let value1: number = this.velocidadCL1_9;
  ...
  changeCL1_9() {
    this.apiGetComp.GetJson(this.api.urlapixplmatbagapp02 + '/api/v1/device?device=' + 'CL1_9')
    ...
    .subscribe((res: any)=>{
      ...
      this.TeamCL1_9 = res[0]
      // this.dataSF1_1 = TeamSF1_1
      this.velocidadCL1_9 = this.decimalPipe.transform(this.TeamCL1_9?.VelocidadActualMotor) ?? 0;
    }
    this.dataCL1_9();
    });
  }
  ...
  dataCL1_9(){
    ...
    .pipe(
      ...
      switchMap( () => this.apiGetComp.GetJson(this.api.urlapixplmatbagapp02 + '/api/v1/device?device=' + 'CL1_9'))
    )
    .subscribe((res: any) => {
      if (JSON.stringify(res)=='{}') {
            console.log('no hay data CL1_9');

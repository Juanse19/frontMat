...
public tooltipInterval1: number;
  ...
  changeMU1_1M02() {
    this.apiGetComp.GetJson(this.api.apiUrlNode1 + '/api/v1/device?device=' + 'MU1_1')
  ...
  dataMU1_1M02(){
    ...
    .pipe(
      ...
      switchMap( () => this.apiGetComp.GetJson(this.api.apiUrlNode1 + '/api/v1/device?device=' + 'MU1_1'))
    )
    .subscribe((res: any) => {

...
public tooltipInterval1: number;
  ...
  changeMU1_2() {
    this.apiGetComp.GetJson(this.api.apiUrlNode1 + '/api/v1/device?device=' + 'MU1_2')
  ...
  dataMU1_2(){
    ...
    .pipe(
      ...
      switchMap( () => this.apiGetComp.GetJson(this.api.apiUrlNode1 + '/api/v1/device?device=' + 'MU1_2'))
    )
    .subscribe((res: any) => {

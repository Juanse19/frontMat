...
export interface MU1_4 {
  MU1_4_VelocidadActualMotor: number,
  MU1_4_CorrienteActualMotor: number,
  MU1_4_PotenciaActualMotor: number,
  MU1_4_TorqueActualMotor: number,
  MU1_4_KWh: number,
  MU1_4_voltaje: number
}
...
export class Mu1_4Component implements OnInit {

  private alive=true;

  public TeamMU1_4: DeviceXpl;

  public velocidadMU1_4: any = 0;
  intervalSubscriptionItems?: Subscription;

  @ViewChild('gaugeMU1_4')
...
public tooltipInterval1: number;
  ...
  gauge(){
    if (document.getElementById('sample-data')) {
      let value1: number = this.velocidadMU1_4;
  ...
  changeMU1_4() {
    this.apiGetComp.GetJson(this.api.urlapixplmatbagapp02 + '/api/v1/device?device=' + 'MU1_4')
    ...
    .subscribe((res: any)=>{
      ...
      this.TeamMU1_4 = res[0]
      this.velocidadMU1_4 = this.TeamMU1_4?.VelocidadActualMotor ?? 0;
    }
    this.dataMU1_4();
    });
  }
  ...
  dataMU1_4(){
    ...
    .pipe(
      ...
      switchMap( () => this.apiGetComp.GetJson(this.api.urlapixplmatbagapp02 + '/api/v1/device?device=' + 'MU1_4'))
    )
    .subscribe((res: any) => {
      if (JSON.stringify(res)=='{}') {
            console.log('no hay data MU1_4');

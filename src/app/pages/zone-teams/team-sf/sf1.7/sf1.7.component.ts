...
export interface SF1_7 {
  SF1_7_VelocidadActualMotor: number,
  SF1_7_CorrienteActualMotor: number,
  SF1_7_PotenciaActualMotor: number,
  SF1_7_TorqueActualMotor: number,
  SF1_7_KWh: number,
  SF1_7_voltaje: number
}
...
export class Sf1_7Component implements OnInit {

  private alive=true;

  public TeamSF1_7: DeviceXpl;

  public velocidadSF1_7: any = 0;
  intervalSubscriptionItems?: Subscription;

  @ViewChild('gaugeSF1_7')
...
public tooltipInterval1: number;
  ...
  gauge(){
    if (document.getElementById('sample-data')) {
      let value1: number = this.velocidadSF1_7;
  ...
  changeSF1_7() {
    this.apiGetComp.GetJson(this.api.urlapixplmatbagapp02 + '/api/v1/device?device=' + 'SF1_7')
    ...
    .subscribe((res: any)=>{
      ...
      this.TeamSF1_7 = res[0]
      // this.dataSF1_1 = TeamSF1_1
      this.velocidadSF1_7 = this.TeamSF1_7?.VelocidadActualMotor ?? 0;
    }
    this.dataSF1_7();
    });
  }
  ...
  dataSF1_7(){
    ...
    .pipe(
      ...
      switchMap( () => this.apiGetComp.GetJson(this.api.urlapixplmatbagapp02 + '/api/v1/device?device=' + 'SF1_7'))
    )
    .subscribe((res: any) => {
      if (JSON.stringify(res)=='{}') {
            console.log('no hay data SF1_7');

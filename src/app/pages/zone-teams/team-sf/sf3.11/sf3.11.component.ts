...
public tooltipInterval1: number;
  ...
  changeSF3_11() {
    this.apiGetComp.GetJson(this.api.urlapixplmatbagapp02 + '/api/v1/device?device=' + 'SF3_11')
    ...
    .subscribe((res: any)=>{
      ...
      this.velocidadSF3_11 = this.TeamSF3_11?.VelocidadActualMotor ?? 0;
    }
    this.dataSF3_11();
    });
  }
  ...
  dataSF3_11(){
    ...
    .pipe(
      ...
      switchMap( () => this.apiGetComp.GetJson(this.api.urlapixplmatbagapp02 + '/api/v1/device?device=' + 'SF3_11'))
    )
    .subscribe((res: any) => {
      if (JSON.stringify(res)=='{}') {
            console.log('no hay data SF3_11');

...
export class Cs1_5Component implements OnInit {

  private alive=true;

  public TeamCS1_5M01: DeviceXpl;

  public velocidadCS1_5M01: any = 0;
  intervalSubscriptionItems?: Subscription;

  @ViewChild('gaugeCS1_5M01')
...
public tooltipInterval1: number;
  ...
  gauge(){
    if (document.getElementById('sample-data')) {
      let value1: number = this.velocidadCS1_5M01;
  ...
  changeCS1_5M01() {
    this.apiGetComp.GetJson(this.api.urlapixplmatbagapp02 + '/api/v1/device?device=' + 'CS1_5')
    ...
    .subscribe((res: any)=>{
      ...
      this.TeamCS1_5M01 = res[0]
      // this.dataSF1_1 = TeamSF1_1
      this.velocidadCS1_5M01 = this.decimalPipe.transform(this.TeamCS1_5M01?.VelocidadActualMotor) ?? 0;
    }
    // this.dataCS1_5M01();
    });
  }
  ...
  dataCS1_5M01(){
    ...
    .pipe(
      ...
      switchMap( () => this.apiGetComp.GetJson(this.api.urlapixplmatbagapp02 + '/api/v1/device?device=' + 'CS1_5'))
    )
    .subscribe((res: any) => {
      if (JSON.stringify(res)=='{}') {
            console.log('no hay data CS1_5M01');

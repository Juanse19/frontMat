...
export interface CS3_7M01 {
  CS3_7M01_VelocidadActualMotor: number,
  CS3_7M01_CorrienteActualMotor: number,
  CS3_7M01_PotenciaActualMotor: number,
  CS3_7M01_TorqueActualMotor: number,
  CS3_7M01_KWh: number,
  CS3_7M01_voltaje: number
}
...
export class Cs3_7Component implements OnInit {

  private alive=true;

  public TeamCS3_7M01: DeviceXpl;

  public velocidadCS3_7M01: any = 0;
  intervalSubscriptionItems?: Subscription;

  @ViewChild('gaugeCS3_7M01')
...
public tooltipInterval1: number;
  ...
  gauge(){
    if (document.getElementById('sample-data')) {
      let value1: number = this.velocidadCS3_7M01;
  ...
  changeCS3_7M01() {
    this.apiGetComp.GetJson(this.api.urlapixplmatbagapp02 + '/api/v1/device?device=' + 'CS3_7')
    ...
    .subscribe((res: any)=>{
      ...
      this.TeamCS3_7M01 = res[0]
      // this.dataSF1_1 = TeamSF1_1
      this.velocidadCS3_7M01 = this.decimalPipe.transform(this.TeamCS3_7M01?.VelocidadActualMotor) ?? 0;
    }
    this.dataCS3_7M01();
    });
  }
  ...
  dataCS3_7M01(){
    ...
    .pipe(
      ...
      switchMap( () => this.apiGetComp.GetJson(this.api.urlapixplmatbagapp02 + '/api/v1/device?device=' + 'CS3_7'))
    )
    .subscribe((res: any) => {
      if (JSON.stringify(res)=='{}') {
            // console.log('no hay data CS3_7M01');
